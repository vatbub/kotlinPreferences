 ...
 * @param internalUniqueStringRepresentation A unique and constant string representation of this key. The keys and values are internally stored as strings. This [internalUniqueStringRepresentation] must therefore be unique within this application. If non-unique keys are used, behaviour is undefined.
 ...
 */
abstract class Key<T>(val internalUniqueStringRepresentation: String, val defaultValue: T, val parser: (String) -> T, val serializer: (T) -> String)
